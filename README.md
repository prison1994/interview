...
1. 这个东西跟fork一样，子进程如果读，父子进程共用这一块物理内存，子进程如果修改了某个变量的值，再去映射到另一块物理内存
2. https://blog.csdn.net/Li_Ning_/article/details/51348830
